...
func _ready():
	...
	$GridContainer/MoveSpeedLabel.text = "Move Speed: " + str(Global.move_speed_boost) + "\n"
	...
	$GridContainer/NumProjectilesLabel.text = "Add'l Projectiles: " + str(Global.num_extra_projectiles) + "\n"
